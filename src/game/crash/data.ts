import type { TopWin, RoundResult } from './types';

export const topWins: TopWin[] = [
  { id: 'tw1', name: 'Dmitriy', vip: 7, multiplier: 'x48.32', amount: '421 000 ₽' },
  { id: 'tw2', name: 'RocketMan', vip: 5, multiplier: 'x32.10', amount: '289 000 ₽' },
  { id: 'tw3', name: 'LuckyStrike', vip: 7, multiplier: 'x21.05', amount: '189 000 ₽' },
  { id: 'tw4', name: 'BlazeIt', vip: 3, multiplier: 'x15.80', amount: '142 200 ₽' },
  { id: 'tw5', name: 'Nika_777', vip: 6, multiplier: 'x12.40', amount: '111 600 ₽' },
  { id: 'tw6', name: 'HighRoller', vip: 9, multiplier: 'x9.90', amount: '89 100 ₽' },
  { id: 'tw7', name: 'Mara_K', vip: 4, multiplier: 'x7.50', amount: '67 500 ₽' },
  { id: 'tw8', name: 'Oleg_T', vip: 2, multiplier: 'x5.20', amount: '46 800 ₽' },
];
