...
import { ChevronLeft, TrendingUp, BookOpen, X, Users, Star } from 'lucide-react';
import { useCrashGame } from './useCrashGame';
import CrashGraph from './CrashGraph';
import BetSlot from './BetSlot';
import { topWins, initialHistory, pillColor } from './data';
                ...
                {topWins.map((w) => (
                  <div key={w.id} className="flex items-center gap-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-white text-[12px] font-bold leading-tight truncate">{w.name}</div>
                      <div className="text-white/30 text-[10px] leading-tight">{w.multiplier}</div>
                    </div>
